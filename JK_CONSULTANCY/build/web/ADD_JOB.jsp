...
<html lang="en" dir="ltr">
    ...
    <header class="site-header clearfix">
        <nav>
            ...
            <div class="button1">
                ...
                <div class="button2">
                    <a href="Adminhub.jsp"><button class="btn1">BACK</button></a> 
                </div>
            </div>
        </nav
    </header>
    <body>
        <div class="container">
            ...
            <div class="content">
                <form action="ADD_JOB1.jsp" mathod="post">
                    <div class="user-details">
                        <div class="input-box">
                            <span class="details">Enter ID</span>
                            <input type="text" size="200" name="id"  required>
                        </div>
                        <div class="input-box">
                            <span class="details">Enter Company Name</span>
                            <input type="text" size="200" name="company"  required>
                        </div>
                        <div class="input-box">
                            <span class="details">Enter Package</span>
                            <input type="text" name="package" value="" required />
                        </div>

                        <div class="input-box">
                            <span class="details">Enter Job Location</span>
